...
let dungeonRuns = { thisRun: null, lastRun: null, towerMode: false, towerDiff: null, towerSnapshot: null, towerWave: 0 };
...
const server = http.createServer(async (req, res) => {
  ...
  if (req.method === 'POST' && req.url === '/dungeon-runs') {
    try {
      ...
      if ('towerMode'     in json) dungeonRuns.towerMode     = json.towerMode;
      if ('towerDiff'     in json) dungeonRuns.towerDiff     = json.towerDiff;
      if ('towerSnapshot' in json) dungeonRuns.towerSnapshot = json.towerSnapshot;
      if ('towerWave'     in json) dungeonRuns.towerWave     = json.towerWave;
